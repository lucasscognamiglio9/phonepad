...
3. En Mac, conceder al binario Accesibilidad y Grabación de pantalla cuando el sistema lo solicite; reiniciarlo tras conceder Accesibilidad. En Windows, aceptar la selección de pantalla del navegador. En la página local, elegir la pantalla y mantenerla abierta durante el uso.
